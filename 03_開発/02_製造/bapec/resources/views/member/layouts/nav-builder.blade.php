...
<div class="c-sidebar-brand">
  <img class="c-sidebar-brand-full" src="{{asset('/images/logo.jpg')}}" style="width: 100%; height:56px;" alt="Logo">
  <img class="c-sidebar-brand-minimized d-none" src="{{asset('/images/logo.png')}}" width="46" height="46"
    alt="Logo">
</div>
